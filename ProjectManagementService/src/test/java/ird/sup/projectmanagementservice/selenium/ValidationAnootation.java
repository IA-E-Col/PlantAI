...
public class ValidationAnootation {

    public static void main(String[] args) {
        // 1. Configurer le driver Firefox
        System.setProperty("webdriver.gecko.driver", "C:\\Program Files\\geckodriver-v0.34.0-win64\\geckodriver.exe");
        ...
        emailInput.sendKeys("chayma.bensaadf@gmail.com");
        driver.findElement(By.id("password")).sendKeys("rootroot1");
